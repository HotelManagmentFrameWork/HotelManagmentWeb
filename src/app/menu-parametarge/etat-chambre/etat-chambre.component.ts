...
@Component({
  ...
  styleUrls: ['./etat-chambre.component.css', '.../../../src/assets/css/StyleApplication.css'], providers: [ConfirmationService, MessageService]
})
export class EtatChambreComponent {
  IsLoading = true;
  openModal!: boolean;
