...
@Component({
  selector: 'app-type-sejour',
  templateUrl: './type-sejour.component.html',
  styleUrls: ['./type-sejour.component.css', '.../../../src/assets/css/StyleApplication.css'], providers: [ConfirmationService, MessageService]
})
