...
@Component({
  ...
  styleUrls: ['./convention.component.css', '.../../../src/assets/css/StyleApplication.css'], providers: [ConfirmationService, MessageService]
})
export class ConventionComponent {
  ...
  GetColumns() {
    this.cols = [
      { field: 'designationArSociete', header: 'الجهة', width: '5%', filter: "true" },
