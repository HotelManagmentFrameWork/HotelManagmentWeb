  ...
  var menuleft = function () {
    if ($('div').hasClass('section-menu-left')) {
      ...
      bt.on("click", function (event) {
        event.stopPropagation(); // Prevent clicks on has-children from bubbling up
        ...
        if ($(this).hasClass("active")) {
          subMenu.slideUp(args, function() {
            $(this).css("display", "none"); 
          });
          $(this).removeClass("active");
        } else {
          $(".sub-menu").slideUp(args, function() {
            $(this).css("display", "none");
          });
          $(".menu-item.has-children").removeClass("active");
      ...
      // Click handler for section-menu-left (to close menus when clicking outside)
       $(".section-menu-left").on("click", function(event) {
         if (!$(event.target).closest(".has-children").length) { // Check if click is outside a has-children element
      ...
      $(".sub-menu").css("display", "none"); // Initial state
